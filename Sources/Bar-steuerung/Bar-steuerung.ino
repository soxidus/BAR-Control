...
/**************************** FOR OTA **************************************************/
#define SENSORNAME "Bar-LED" //change this to whatever you want to call your device
...
const char* light_state_topic = "bar/rgb";
const char* light_set_topic = "bar/rgb/set";
